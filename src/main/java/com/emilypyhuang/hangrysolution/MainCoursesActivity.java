...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Dish[] mainCourses = {
                new Dish("Thai basil and fried rice", "A crisp salad featuring fresh thai basil and mulberry", 1499),
                new Dish("Onion roll", "Warm ciabatta filled with caramalised onion and fresh apple", 1299),
